...
$$ {sim(q,d)} = \\vec{q} \\cdot \\vec{d} = \\sum\\_{t\\ \\text{in both q and d}} w\\_{t,q} \\times w\\_{t,d}.$$
...
$$ \\overline{sim(q,r)} = \\sum_{t \\in T_1} w\\_{t,q} \\times w\\_{t,r} + \\sum\\_{t\\in T\\_2} w\\_{t,q} \\times \\overline{w\\_{t,r}}.$$
